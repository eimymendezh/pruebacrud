...
<li>Name:</li><li><input type='text' name='username_updated' value='$row[username]' /></li>
...
if (isset($_POST['new']))
{
$result1 = pg_query($db, "UPDATE users SET id = '$_POST[id_updated]', username = '$_POST[username_updated]', password = '$_POST[password_updated]'");
if (!$result1)
{
echo "Update failed!!";
} else
